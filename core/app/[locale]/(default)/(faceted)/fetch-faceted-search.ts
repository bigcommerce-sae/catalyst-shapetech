...
type GetProductSearchResultsQueryVariables = VariablesOf<typeof GetProductSearchResultsQuery>;
type SearchProductsSortInput = GetProductSearchResultsQueryVariables['sort'];
type SearchProductsFiltersInput = GetProductSearchResultsQueryVariables['filters'];
